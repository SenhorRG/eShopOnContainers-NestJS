...
/** Ordering service publisher (routing key `OrderStatusChangedToStockConfirmedIntegrationEvent`). */
export class OrderStatusChangedToStockConfirmedIntegrationEvent extends IntegrationEvent {
  OrderId!: number;
  ...
  static revive(json: IntegrationJson): OrderStatusChangedToStockConfirmedIntegrationEvent {
    const rec = json as Record<string, unknown>;
    return new OrderStatusChangedToStockConfirmedIntegrationEvent(
      Number(rec.OrderId),
