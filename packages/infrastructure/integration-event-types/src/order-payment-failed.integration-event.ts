...
export class OrderPaymentFailedIntegrationEvent extends IntegrationEvent {
  OrderId!: number;
  ...
  static revive(json: IntegrationJson): OrderPaymentFailedIntegrationEvent {
    const rec = json as Record<string, unknown>;
    return new OrderPaymentFailedIntegrationEvent(
      Number(rec.OrderId),
