...
export class OrderStatusChangedToCancelledIntegrationEvent extends IntegrationEvent {
  OrderId!: number;
  ...
  static revive(json: IntegrationJson): OrderStatusChangedToCancelledIntegrationEvent {
    const rec = json as Record<string, unknown>;
    return new OrderStatusChangedToCancelledIntegrationEvent(
      Number(rec.OrderId),
